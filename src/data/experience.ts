...
export const experiences: Experience[] = [
  {
    ...
    responsibilities: [
      "Build and ship client apps — Django/DRF or Nest on the backend, TanStack or Next.js on the frontend.",
    ],
    achievements: [
      "Helped take several client apps from empty repo to tools staff use daily.",
  ...
  },
  {
    ...
    location: "Lahore, Pakistan",
    description:
      "Client platforms in healthcare, PropTech, auctions, and AI — Django REST backends, React and Next.js frontends, and CI/CD that actually runs.",
    stack: [
      "Django",
      "DRF",
      "Flask",
    ...
    responsibilities: [
      "Built production web apps with Django, Django REST Framework, React, and Next.js.",
      "Wrote REST APIs and smaller services in Django and Flask — JWT, Postgres, and pragmatic architecture.",
      ...
      "Sat with interns and juniors on PRs, pair sessions, and review notes people actually used.",
