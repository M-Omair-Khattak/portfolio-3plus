export const profile = {
  ...
  bio: `I'm a full stack developer with 3+ years on production web apps. Most of that time is Python on the backend (Django, DRF, FastAPI) and React or Next.js on the frontend. Lately I also ship a lot of TanStack apps, plus the jobs nobody puts on a landing page: Celery workers, Playwright scrapers, CI, and AWS.`,
  extendedBio: `A couple of years at Arbisoft on client products — health testing, PropTech, auctions, AI tools. Since Oct 2025 I've been at Ubiquify, where I take a messy workflow (faxes, dealer portals, Procore, call recordings) and turn it into something the team actually logs into. I use Cursor every day. That's not a personality; it just means a working slice shows up sooner.`,
  values: [
    {
  ...
  highlights: [
    "3+ years on Django, React, and Next.js",
